	...
	<link rel="stylesheet" href="${url }/admin/assets/css/ace.min.css" />
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				mtype:"POST",
				url:'<%=request.getAttribute("url")%>/contact/list.htm',
				datatype: "json",
					colNames:['', 'ID','评论者主页', '邮箱','昵称','内容'],
					colModel:[
						{name:'myac',index:'id', width:80, fixed:true, sortable:false, resize:false,
							formatter:'actions', 
							formatoptions:{ 
								keys:true,
						...
						{name:'website',index:'website',width:150, sortable:false,editable: true,edittype:"textarea", editoptions:{rows:"2",cols:"20"}},
...
// 						{name:'bid',index:'bid', width:70, editable: true},
					], 
					...
					editurl:"<%=request.getAttribute("url")%>/contact/oper.htm",//nothing is saved
					deleteurl:"<%=request.getAttribute("url")%>/contact/oper.htm",//nothing is saved
					caption: "评论管理",
					height:500,
					autowidth: true
				});
