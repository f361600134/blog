	...
	<link rel="stylesheet" href="${url }/admin/assets/css/ace.min.css" />
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				url:'<%=request.getAttribute("url")%>/link/list.htm',
				mtype:"post",
				datatype: "json",
					...
					colModel:[
						...
						{name:'site',index:'site',width:150, sortable:false,editable: true,edittype:"textarea", editoptions:{rows:"2",cols:"20"}},
...
// 						{name:'sort',index:'sort', width:70, editable: true},
					...
					editurl:"<%=request.getAttribute("url")%>/link/oper.htm",//nothing is saved
					caption: "友链管理",
					height:500,
